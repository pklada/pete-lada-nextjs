...
export const Layout = ({ children }: { children: React.ReactNode }) => {
    ...
    const [overlayContent, setOverlay] = React.useState<{ title: string | undefined, content: ReactNode }>({ title: undefined, content: undefined });
            ...
            >
                <AccentContextWrapper rgb={accentRgb}>
                    <LayoutContext.Provider value={{ hasLoaded, setHasLoaded }}>
                        ...
                        >
                            <main
                                className={`${styles.layout} ${hasLoaded ? styles.hasLoaded : undefined
                                    }`}
                            >
