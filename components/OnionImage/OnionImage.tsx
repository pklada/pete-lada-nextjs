...
export const OnionImage = ({ imgSrc, altImgSrc }: OnionImageProps) => {
    ...
    const handleMouseMove = (e: React.MouseEvent) => {
        ...
        if (newX < 5) {
            newX = 5;
        } else if (containerRef.current && newX > containerRef.current?.clientWidth - 5) {
    ...
    return (
        ...
        >
            <div className={styles.topImage} style={{
                ...
                transition: shouldAnimate ? `transform ease ${animationDuration}ms` : undefined
            }}>
            ...
            <div
                ...
                style={{ transform: `translateX(${offset}px)`, transition: shouldAnimate ? `transform ease ${animationDuration}ms` : undefined }}
            ...
            >
                <div className={styles.handleGrabber}>
                    <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M7.87891 1.36914e-07L11.8789 4L7.87891 8V1.36914e-07Z" fill="#C4C4C4" />
                    </svg>
                </div>
