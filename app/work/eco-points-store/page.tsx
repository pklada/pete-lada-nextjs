            ...
            <div className={styles.body}>
              <div className={styles.section}>
                ...
                <TextBlock>
                  ...
                  <Text>
                    I pushed for prioritization and designed the Eco Points
                    Store, where Eco users can spend the points they earn on the
                    platform.
                  </Text>
                  <SectionTitle>Background</SectionTitle>
                  <Text>
                    To address churn and growth challenges, we conducted user
                    research to determine where Eco as a product was falling
                    short. The ability to derive value from Eco Points was
                    frequently cited. I pushed the executive team to prioritize
                    the ability to spend Eco Points in product, and designed the
                    experience for two programs: Point Drops and Eco Credit.
                  </Text>
                </TextBlock>
              </div>
              ...
              <figure className={`${styles.section} ${styles.fullWidth}`}>
                ...
                <figcaption className={styles.sectionCaption}>
                  <Text intensity="medium">
                    A sampling of feedback we gathered from user studies. In
                    this batch, nearly 50% cited Eco Points (lack of) value as
                    the reason they churned.
                  </Text>
                </figcaption>
              </figure>
              ...
              <div className={styles.section}>
                <TextBlock>
                  ...
                  <Text>
                    Since joining Eco, I felt strongly about introducing a way
                    to spend points as soon as possible. Intuitively, it felt
                    like a missing piece of the experience - users would
                    accumulate points on the platform for various actions, but
                    had no ability to redeem them in a meaningful way. We played
                    around the edges, but never allocated resources to the
                    initiative, instead focusing on features to reach
                    bank-parity.
                  </Text>
                  <Text>
                    After conducting a series of research studies to address
                    churn and growth concerns, we learned the lack of point
                    spend programs was becoming increasingly problematic.{' '}
                    <b>
                  ...
                  <Text>
                    Proactively, I put together a set of rough designs on a
                    point store experience and pitched the programs to the
                    executive team via a series of Loom recordings (
                    ...
                    product direction was enough to give our team the green
                    light to devote resources to the problem.
                  </Text>
                </TextBlock>
              </div>
              ...
              <div className={styles.section}>
                <TextBlock>
                  ...
                  <Text>
                    We took my initial concepts and pared them down to two
                    initial programs: <b>Points Drops</b> and <b>Eco Credit</b>.
                    We felt this was broad enough for an MVP, while being scoped
                    narrowly enough to execute on quickly. They also had the
                    benefit of each addressing a pillar of one of Eco's core
                    philosophies:{' '}
                    <em>
              ...
              <section className={`${styles.section} ${styles.wide}`}>
                <div className={styles.figureGrid}>
                  <figure>
                    ...
                    <figcaption className={styles.sectionCaption}>
                      <Text intensity="medium">
                        The purchase flow for a drop. I designed and built a
                        bunch of custom interactions and animations for this
                        flow.
                      </Text>
                    </figcaption>
                  </figure>
                  <figure>
                    ...
                    <figcaption className={styles.sectionCaption}>
                      <Text intensity="medium">
                        We created a story for each new drop. The user would
                        also be notified via email and push notif.
                      </Text>
                    </figcaption>
                  </figure>
                </div>
              ...
              <div className={styles.section}>
                <TextBlock>
                  ...
                  <Text>
                    ...
                    implemented a series of promotional items which I designed.
                    We sent out a series of emails leading up to launch (example
                    below) and introduced a new promotional app-launch sheet. We
                    also sent a story (Eco's version of an interactive
                    notification) to all users for the first drop, as well as a
                    video story promoting the program in general.
                  </Text>
                </TextBlock>
              </div>
              ...
              <section className={`${styles.section} ${styles.wide}`}>
                <div className={styles.figureGrid}>
                  <figure>
                    ...
                    <figcaption className={styles.sectionCaption}>
                      <Text intensity="medium">
                        A promotional sheet we'd show to new and existing users
                        when they entered Eco post-launch.
                      </Text>
                    </figcaption>
                  </figure>
                  <figure>
                    ...
                    <figcaption className={styles.sectionCaption}>
                      <Text intensity="medium">
                        One of the promotional emails we sent for the Points
                        Store launch. I also built and designed Eco's entire
                        email system.
                      </Text>
                    </figcaption>
                  </figure>
              ...
              <div className={styles.section}>
                <TextBlock>
                  ...
                  <Text>
                    As of writing, the Points store is still brand new, having
                    been released only 2 weeks prior. Early signals are
                    extremely positive though, and solidify our decision to put
                    time and development effort into the launch. Some early
                    results:
                  </Text>
                  <ArrowList
                    items={[
