                        ...
                        <div className={styles.body}>
                            <div className={styles.section}>
                                <PostInfo items={[
                                    ...
                                    { key: "Year", value: "2023" },
                                    { key: "My role", value: <>Design direction<br />UI/UX design<br />Implementation</> }
                                ]} />
                                <TextBlock>
                                    <SectionTitle>Summary</SectionTitle>
                                    <Text>I pushed for prioritization and designed the Eco Points Store, where Eco users can spend the points they earn on the platform.</Text>
                                    <SectionTitle>Background</SectionTitle>
                                    <Text>To address churn and growth challenges, we conducted user research to determine where Eco as a product was falling short. The ability to derive value from Eco Points was frequently cited. I pushed the executive team to prioritize the ability to spend Eco Points in product, and designed the experience for two programs: Point Drops and Eco Credit.</Text>
                                </TextBlock>
                            </div>
                            ...
                            <figure className={`${styles.section} ${styles.fullWidth}`}>
                                <Browser url="https://docs.google.com">
                                    <div className={styles.image}>
                                        <ZoomableImage imgSrc="/eco-points-feedback.jpg" subtitle="Old Quora messages vs. the new redesign." />
                                    </div>
                                </Browser>
                                <figcaption className={styles.sectionCaption}><Text intensity="medium">A sampling of feedback we gathered from user studies. In this batch, nearly 50% cited Eco Points (lack of) value as the reason they churned.</Text></figcaption>
                            </figure>
                            ...
                            <div className={styles.section}>
                                <TextBlock>
                                    ...
                                    <Text>We took my initial concepts and pared them down to two initial programs: <b>Points Drops</b> and <b>Eco Credit</b>. We felt this was broad enough for an MVP, while being scoped narrowly enough to execute on quickly. They also had the benefit of each addressing a pillar of one of Eco's core philosophies: <em><b>"head in the clouds, feet on the ground"</b></em>. Drops were meant to be aspirational and magical <i>("head in the clouds")</i> while credit was meant to be grounded and utilitarian <i>("feet on the ground")</i>.</Text>
                                </TextBlock>
                            </div>
                            ...
                            <section className={`${styles.section} ${styles.wide}`}>
                                <div className={styles.figureGrid}>
                                    <figure>
                                        <IPhone>
                                            <ZoomableImage videoSrc="/eco-drop-purchase.mp4" subtitle="The primary entry point into the Credit summary view is via a user's dashboard." />
                                        </IPhone>
                                        <figcaption className={styles.sectionCaption}>
                                            <Text intensity="medium">The purchase flow for a drop. I designed and built a bunch of custom interactions and animations for this flow.</Text>
                                        </figcaption>
                                    </figure>
                                    <figure>
                                        <IPhone>
                                            <ZoomableImage imgSrc="/eco-drop-story.jpg" subtitle="We created a story for each new drop. The user would also be notified via email and push notif." />
                                        </IPhone>
                                        <figcaption className={styles.sectionCaption}>
                                            <Text intensity="medium">We created a story for each new drop. The user would also be notified via email and push notif.</Text>
                                        </figcaption>
                                    </figure>
                                </div>
                            </section>
                            ...
                            <section className={`${styles.section} ${styles.wide}`}>
                                <div className={styles.figureGrid}>
                                    <figure>
                                        <IPhone>
                                            <ZoomableImage videoSrc="/eco-credit-summary.mp4" subtitle="The primary entry point into the Credit summary view is via a user's dashboard." />
                                        </IPhone>
                                    ...
                                    <figure>
                                        <IPhone>
                                            <ZoomableImage videoSrc="/eco-credit-sold-out.mp4" subtitle="Credit can 'sell out' each month. This gives Eco some protection and prevents mass points liquidation." />
                                        </IPhone>
                                    ...
                                    <figure>
                                        <IPhone>
                                            <ZoomableImage videoSrc="/eco-credit-purchase.mp4" subtitle="Purchasing credit is a simple flow, which deducts Points from a user's Point balance." />
                                        </IPhone>
                                    ...
                                    <figure>
                                        <IPhone>
                                            <ZoomableImage videoSrc="/eco-credit-merchant.mp4" subtitle="Credit is represented in the UI with a purple treatment, and the credit icon." />
                                        </IPhone>
                            ...
                            <section className={`${styles.section} ${styles.wide}`}>
                                <div className={styles.figureGrid}>
                                    <figure>
                                        <IPhone>
                                            <ZoomableImage imgSrc="/eco-points-store-sheet.jpg" imgSrc2x="/eco-points-store-sheet@2x.jpg" subtitle="A promotional sheet we'd show to new and existing users when they entered Eco post-launch." />
                                        </IPhone>
                                        <figcaption className={styles.sectionCaption}><Text intensity="medium">A promotional sheet we'd show to new and existing users when they entered Eco post-launch.</Text></figcaption>
                                    </figure>
                                    <figure>
                                        <IPhone>
                                            <ZoomableImage videoSrc="/eco-points-store-email.mp4" subtitle="One of the promotional emails we sent for the Points Store launch. I also built and designed Eco's entire email system." />
                                        </IPhone>
                                        <figcaption className={styles.sectionCaption}><Text intensity="medium">One of the promotional emails we sent for the Points Store launch. I also built and designed Eco's entire email system.</Text></figcaption>
                                    </figure>
                                </div>
                            </section>
                            ...
                            <div className={styles.section}>
                                <TextBlock>
                                    ...
                                    <Text>As of writing, the Points store is still brand new, having been released only 2 weeks prior. Early signals are extremely positive though, and solidify our decision to put time and development effort into the launch. Some early results:</Text>
                                    <ArrowList
                                        items={[
                                            <Text><b>+21% MAU</b> after launch</Text>,
                                            <Text><b>+212% App Installs</b> in the week immediately following release</Text>,
                                            <Text>Generated <b>4.5x the support traffic</b> (generally can be abstracted to product engagement).</Text>
                                        ]}
                                    />
                                </TextBlock>
                            </div>
